...
class Routes {
  ...
  /// [constructors] :
  ///
  /// Func : [int(required) a, String?(required) b, bool? c, double(required) d]
  ...
  /// [constructors] :
  ///
  /// Func1 : [int(required) a, String?(required) b, bool? c, double(required) d]
  ...
  /// [constructors] :
  ///
  /// Func2 : [int(required) a, String?(required) b, bool? c, double(required) d]
  ...
  /// [constructors] :
  ///
  /// Func3 : [int(required) a, String?(required) b, bool? c, double(required) d]
  ...
  /// [constructors] :
  ///
  /// Func4 : [int(required) a, String?(required) b, bool? c, double(required) d]
  ...
  /// [constructors] :
  ///
  /// Func5 : [int(required) a, String?(required) b, bool? c, double(required) d]
  ...
  /// [constructors] :
  ///
  /// $7Func : [int(required) a, String?(required) b, bool? c, double(required) d]
  ...
  ///
  /// [codes] : {'test2': TestPageA.dd, 'test3': TestPageA.ddd, 'test4': TestPageA(), 'test5': TestPageA.ddd}
  ///
  ...
  /// [constructors] :
  ///
  /// TestPageCC : [int(required) testArg, String(required) testRequiredArg, bool? testBoolean]
  ///
