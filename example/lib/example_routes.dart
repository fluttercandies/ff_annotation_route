...
import 'package:example/src/model/test_model.dart' hide TestMode2 show TestMode;
...
class Routes {
  ...
  /// [constructors] :
  ///
  /// TestPageF({BoxWidthStyle boxWidthStyle = ui.BoxWidthStyle.max, ExtendedImageMode extendedImageMode = ExtendedImageMode.gesture, required BlendMode blendMode})
  ///
...
class _FlutterCandiesTestPageF {
  ...
  Map<String, dynamic> d({
    ui.BoxWidthStyle boxWidthStyle = ui.BoxWidthStyle.max,
    ExtendedImageMode extendedImageMode = ExtendedImageMode.gesture,
