...
class Routes {
  ...
  /// [constructors] :
  ///
  /// TestPageSuperParameters({TestMode? argument, String title = 'abc'})
  ///
  ...
  /// [constructors] :
  ///
  /// TestPageB({TestMode? argument, String title = 'dddd'})
  ///
  /// [pageRouteType] : PageRouteType.material
  ///
  /// [exts] : {'group': 'Simple', 'order': 1}
...
class _FlutterCandiesTestPageSuperParameters {
  ...
  Map<String, dynamic> d(
      ...
      <String, dynamic>{
        ...
        'title': title,
        'constructorName': '',
        'argumentNames': <String>['argument', 'title'],
      };
  ...
  Map<String, dynamic> d(
    ...
    String? id = 'flutterCandies',
      ...
      <String, dynamic>{
        ...
        'id': id,
        'constructorName': '',
        'argumentNames': <String>['argument', 'optional', 'id'],
      };
...
class _FlutterCandiesTestPageE {
  ...
  Map<String, dynamic> d(
      ...
      <String, dynamic>{
        ...
        'testMode1': testMode1,
        'constructorName': '',
        'argumentNames': <String>['testMode', 'testMode1'],
      };
